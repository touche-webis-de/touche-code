...
This directory contains a baseline for predicting advertising spans in a RAG response labeled to contain advertisements. 
This baseline takes the RAG response as input.
