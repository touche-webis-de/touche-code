# Naive Baseline For Causality Extraction Task 3 @ Touché 2026
...
```
tira-cli code-submission --path . --task causality-extraction-toucheclef26 --dataset task3-spot-check-dataset-20260430-training --dry-run --command '/predict.py --dataset $inputDataset --output $outputDir'
```