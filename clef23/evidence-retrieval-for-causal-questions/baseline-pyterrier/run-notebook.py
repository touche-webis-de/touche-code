...
def parse_args():
    ...
    parser.add_argument('--image-for-dry-run', type=str, help='The docker image that is to be executed in the dry-run.', default='webis/tira-touche23-task-2-pyterrier-baseline:0.0.1', required=False)
