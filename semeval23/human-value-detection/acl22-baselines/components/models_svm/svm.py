    ...
    def predict(self, X):
        """
            ...
            X : {array-like, sparse matrix} of shape (n_samples, n_features)
                The core_data matrix for which we want to get the predictions
...
def train_svm(train_dataframe, labels, vectorizer_file, model_file, test_dataframe=None):
    """
        ...
        labels : list[str]
            The listing of all labels
        vectorizer_file : str
            The file for storing the fitted core_data from the TfidfVectorizer
        model_file : str
    ...
    # dictionary for storing model core_data
    model_json = {}
