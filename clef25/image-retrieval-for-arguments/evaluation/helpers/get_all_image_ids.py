...
"""
This script scans the images/ directory, collects all image_id folder names,
reports the total and unique counts, and writes the list of image_ids to
image_id_list.txt.
"""

# Define the path to search
path_to_search = Path.cwd() / "images"  # corresponds to Touche dataset
list_of_image_ids = []
