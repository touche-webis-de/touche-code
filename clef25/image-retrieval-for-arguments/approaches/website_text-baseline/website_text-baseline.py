...
arguments_xml_path = Path("../../indexing/arguments.xml")
...
def search_similar_images(query_text, top_n=5):
    """
    searching for similar results based on the field 'pages/snapshot/text'.
    """
    # Elasticsearch-Search-Query
    query = {
        "query": {
            "match": {
                "website_text": query_text
            }
        },
        "size": top_n
    }
...
if __name__ == "__main__":
    ...
    arguments = load_arguments_from_xml(arguments_xml_path)
