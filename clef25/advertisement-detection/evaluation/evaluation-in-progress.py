...
@click.option("--datasets", type=click.Choice(["ads-in-rag-task-1-generation-test-20250506-test"]), multiple=True, help="The dataset id in tira. See https://archive.tira.io/datasets?query=advertisement")
